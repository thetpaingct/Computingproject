        ...
        <nav class="navbar navbar-default navbar-static-top">
            <div class="container">
               ...
               <ul class="nav navbar-nav navbar-right">
                @guest
                @else
 <li><a  class="navbar-brand" href="{{ url('todolist') }}" >
                   Create List

               </a>
               </li>
               <li><a  class="navbar-brand" href="{{ url('note') }}" >
                   Create Note
           ...
           <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                  ...
                  <!--   <li class="dropdown">
                       <a href="{{ url('order/orderlistview1') }}" class="dropdown-toggle" data-toggle="dropdown"> Profile <b class="caret"></b></a>
                       <ul class="dropdown-menu">
                        <li><a href="#" data-toggle="modal" data-target="#basicModal" >Profile</a></li>
                        <li><a href= {{url('order/orderlistview')}} >Order list</a></li>
                        <li><a href="{{ url('logout') }}">Logout</a></li>
                    </ul>
                </li> -->
...
<div class="modal fade" id="basicModal" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <div class="o" id="show1"> 
          ...
          <p> Phone number -{{ Auth::user()->email }}</p>
      </div>
      <div class="l" id="hide1">
       ...
       <!-- <form role="form" method="post" action="{{ url('user/'.$id)}}">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="phone" value="{{ Auth::user()->email }}">
        </div>
       <!--  <div class="form-group">
...
<footer class="footer">
    ...
    <div class="container">
        ...
        <div class="col-md-4">
            <h3>Facebook Page </h3>
            <div class="fb-page" data-href="https://www.facebook.com/time/" data-tabs="timeline" data-width="340" data-height="152" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div>
        </div>
        <div class="col-md-4" >
            <h3>Contact Us</h3>
            <ul>
