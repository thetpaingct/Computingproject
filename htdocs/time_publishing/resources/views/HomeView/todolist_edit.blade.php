...
<div class="container-fluid">
	...
	<div class="row">	
		<div class="col-md-7  col-md-offset-3">
<form class="form-horizontal text-color-custom" method="get" role="form" action="{{ url('todolist/update/'.$todolists['id'])}}">
	{{ csrf_field()}}
	 ...
	 <div class="form-group">
		...
		<label for="inputPassword3" class=" col-md-3 col-md-offset-2  control-label text-align-custom" style="padding-left: 100px; ">To Do List</label>
			<div class=" col-md-5 ">
				 <input   type="text" class="form-control" name="list" value="{{$todolists->list}}">
			</div>
	</div>
