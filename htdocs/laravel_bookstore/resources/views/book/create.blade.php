...
{!! Form::open(array('url' => 'book/create', 'files'=>true, 'class'=>'form-horizontal' ,'name'=>'admin')) !!}
  <div class="form-group col-md-6">
    <label for="inputEmail3" class="col-md-6 control-label">Code number</label>
    <div class="col-md-6">
      <input type="" class="form-control"  placeholder="Code number" name="codenumber" required>
     </div>
    </div>
    <div class="form-group col-md-6">
      <label for="inputEmail3" class="col-md-6 control-label">Book Name</label>
    <div class="col-md-6">
      <input type="" class="form-control"  placeholder="Book Name" name="bookname" required>
  ...
  <div class="form-group col-md-6">
    ...
    <div class="col-md-6">
      <input type="number" class="form-control"  placeholder="Edition" name="edition" required>
      </div>
    </div>
  ...
  <option value="{{ $row['id'] }}">{{ $row['name'] }}</option>
   ...
   <div class="form-group col-md-8">
    ...
    <div class=" col-md-6" style="padding-left: 30px;">
      <textarea class=" col-md-4 form-control"  placeholder="Description" name="description" required> </textarea> 
  ...
  function disablefield()
{
  // alert('here');
          ...
          if (document.admin.customerInfo.value  == "0") 
          {
           
            
            document.getElementById("price").disabled = true;
          }
          else if(document.admin.customerInfo.value == "1") 
         {
